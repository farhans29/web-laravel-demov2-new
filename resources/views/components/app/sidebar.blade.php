<div class="min-w-fit">
    ...
    <!-- Sidebar -->
    <div id="sidebar"
        class="flex lg:flex! flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:w-64! shrink-0 bg-gray-800 dark:bg-gray-900 p-4 transition-all duration-200 ease-in-out "
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="flex flex-row gap-3 items-center" href="{{ route('dashboard') }}">
                ...
                <p class="text-white text-center"><b>A</b></p>
            </a>
        </div>
                                    ...
                                    @can('view_inventory')
                                        <li class="mb-1 last:mb-0" x-data="{ openInventory: {{ in_array(Request::segment(2), ['inventory']) ? 1 : 0 }} }">
                                            <a class="block text-gray-400 hover:text-white hover:text-gray-700 dark:hover:text-gray-200 transition truncate"
                                                ...
                                                <span
                                                    class="text-sm font-medium @if (Route::is('index.inventory', 'indexNew.inventory', 'inventory.create', 'indexEdit.inventory', 'indexDelete.inventory')) {{ 'text-white' }} @endif">Inventory</span>
                                            </a>
